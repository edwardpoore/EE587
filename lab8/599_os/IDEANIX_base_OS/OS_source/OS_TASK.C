...
INT8U  OSTaskCreate (void (*task)(void *pd), void *p_data, OS_STK *ptos, INT8U prio) KCREENTRANT
{
#if OS_CRITICAL_METHOD == 3                  /* Allocate storage for CPU status register               */
    OS_CPU_SR  cpu_sr;
#endif
    ...
    if (OSTCBPrioTbl[prio] == (OS_TCB *)0) { /* Make sure task doesn't already exist at this priority  */
        ...
        OS_EXIT_CRITICAL();
        psp = (OS_STK *)OSTaskStkInit(task, p_data, ptos, 0);    /* Initialize the task's stack         */
...
//ADDED BY DARREN BROWN on AUGUST 31 2006
...
//#define C51  1
//INT8U OS_TaskCreate(void (*task)(void *pd), void *Tdata, OS_STK *pstk, INT16U stksize, INT8U p) KCREENTRANT
//{
//    INT8U *stk, *estk;
//    INT8U  err;
...
//        OS_EXIT_CRITICAL();
//        stk      = (INT8U *)pstk; 
//        estk     = (INT8U *)&stk[stksize];          
//#ifdef  C51                                      /* KEIL C51 with Generic pointer */
//        *stk     = (INT8U)(task);                   /* PCL         */
...
//        *++stk   = 0x00;                            /* B           */
//        *++stk   = 0x00;                            /* R0          */
//        *++stk   = (INT8U)(Tdata);                  /* R1 data LSB */
//*++stk   = (INT8U)((INT16U)Tdata >>8 );      /* R2 data MSB */
// *++stk   = (INT8U)((INT32U)Tdata >>16 );     /* R3 data G   */
//  *++stk   = 0x04;                            /* R4          */
//    *++stk   = 0x05;                            /* R5          */
//     *++stk   = 0x06;                            /* R6          */
//      *++stk   = 0x07;                            /* R7          */
//       *++stk   = 0x00;                            /* DPH         */
//        *++stk   = 0x00;                            /* DPL         */
//        *++stk   = (INT8U)((INT16U)estk >>8 );       /* XSP area MSB*/
//        *++stk   = (INT8U)(estk);                   /* XSP area LSB*/
//        *++stk   = 18;                              /* SP (bytes)  */
//#else
//#error This piece of code only tested with Keil C51
//#endif
//        err = OS_TCBInit(p, (void OS_FAR *)stk);
//        err = OS_TCBInit(p, stk, (OS_STK *)0, 0, 0, (void *)0, 0);
//
//	  	if (err == OS_NO_ERR) {
//            if (OSRunning) {
//                OS_Sched();
...
// end of additions by DARREN BROWN made on AUGUST 31, 2006
